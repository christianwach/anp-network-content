...
<article id="site-<?php echo $site_id; ?>" data-posts="<?php echo $site['post_count']; ?>" data-slug="<?php echo $slug; ?>" data-id="<?php echo $site_id; ?>" data-updated="<?php echo $site['last_updated']; ?>" class="site-item hentry" role="article">
