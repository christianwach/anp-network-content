...
<article id="site-<?php echo $site_id; ?>" class="site-item hentry" role="article">
	...
	<header class="entry-header">
		...
		<?php if ( ! empty( $show_image ) ) { ?>
			<a href="<?php echo esc_url( $site['siteurl'] ); ?>" class="item-image site-image" title="<?php echo esc_attr( $site['blogname'] ); ?>" style="background-image:url('<?php echo $site['site-image']; ?>'); ?>"></a>
		<?php } ?>
